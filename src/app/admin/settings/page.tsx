...
export default function AdminSettings() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <Glass className="p-8 rounded-[28px]">
              ...
              {GATEWAYS.map((gw) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      borderColor: isActive ? gw.color + "55" : "rgba(255,255,255,0.08)",
                      boxShadow: isActive ? `0 0 24px ${gw.color}22` : undefined,
                    }}
                  >
                    {isActive && (
                      <span
        ...
        >
          <Glass className="p-8 rounded-[28px]">
            ...
            <button
              ...
              className="flex items-center gap-2.5 font-bold text-[13px] px-6 py-3 rounded-xl transition-all active:scale-[0.98] disabled:opacity-40 text-white"
